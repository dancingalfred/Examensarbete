...
#Removed location specific data
    if idLvl2 == "XXX":
        fixed_document = {"Sensor address": "XXX"}
...
def queryTrafikverketAPI():
    #Removed my Key from request
    data = """
        <REQUEST>
            <LOGIN authenticationkey="INSERT KEY HERE" /> 
...
def getWeatherForecast():
    #Removed key from request
    url = "https://api.tomorrow.io/v4/timelines?location=59.6062%2C%2016.5539&fields=temperature&units=metric&timesteps=1h&startTime=now&endTime=nowPlus6h&apikey= Insert KEY HERE"
    headers = {
